...
e caso seja, imprima a nacionalidade no console. O último `else` deve imprimir "nacionalidade não encontrada" caso o valor de `nacionalidade` não corresponda 
...
if (nacionalidade === "brasileira" || nacionalidade === "argentina" || nacionalidade === "auruguaia" || nacionalidade === "chilena"){
